...
TARGET_RECOVERY_UI_LIB := librecovery_ui_tulip_perf
...
BOARD_HAVE_BLUETOOTH_NAME := ap6335
#BOARD_HAVE_BLUETOOTH_RTK := true
#BLUETOOTH_HCI_USE_RTK_H5 := true
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/softwinner/tulip-perf/bluetooth
