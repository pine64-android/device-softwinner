...
TARGET_RECOVERY_UI_LIB := librecovery_ui_kylin_p2
...
SW_BOARD_USES_SENSORS_TYPE := invensense
SW_BOARD_GYRO := 6500
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/softwinner/kylin-p2/bluetooth
