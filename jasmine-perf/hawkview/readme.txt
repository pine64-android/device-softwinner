...
　　
   ...
   在Android\device\softwinner\jasmine-xxx\jasmine_xxx.mk文件中按如下方法增加配置:

# camera config for camera detector
PRODUCT_COPY_FILES += \
	device/softwinner/jasmine-xxx/hawkview/sensor_list_cfg.ini:system/etc/hawkview/sensor_list_cfg.ini
　　
使用说明：
